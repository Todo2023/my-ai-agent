...
# 既に投稿されている内容。町の4施設それぞれの見た目を確かめるために入れてある。
# ひろば（showcase）はAIが書いた物語、ほかの3施設は飼い主の言葉そのまま。
BASE_POSTS = [
    {
    ...
    },
    {
        ...
        "category": "question",
        "post_type": "A",
        "title": "みんなは暑さ対策ってどんなことしてる？",
        "question": None,
        "raw_input": "みんなは暑さ対策ってどんなことしてる？うちは日中エアコンをつけっぱなしにしているけど、"
                     "設定温度をどのくらいにしているか気になっています。",
        "generated_story": "みんなは暑さ対策ってどんなことしてる？うちは日中エアコンをつけっぱなしにしているけど、"
                           "設定温度をどのくらいにしているか気になっています。",
        "created_at": "2026-08-22T13:20:00+09:00",
    },
    {
        ...
        "category": "learn",
        "post_type": "A",
        "title": "デンタルケアの正しいやり方を学びたい",
        "question": None,
        "raw_input": "歯みがきを嫌がるので、途中でやめてしまいます。"
                     "少しずつ慣らしていく手順を知っている方がいたら教えてほしいです。",
        "generated_story": "歯みがきを嫌がるので、途中でやめてしまいます。"
                           "少しずつ慣らしていく手順を知っている方がいたら教えてほしいです。",
    ...
    },
    {
        ...
        "category": "goods",
        "post_type": "A",
        "title": "最近買ったウェアが着せやすくてオススメ",
        "question": None,
        "raw_input": "前あきタイプのウェアに変えたら、着せるときに嫌がらなくなりました。"
                     "洗濯してもへたらないので、雨の日用にもう1枚買い足す予定です。",
        "generated_story": "前あきタイプのウェアに変えたら、着せるときに嫌がらなくなりました。"
                           "洗濯してもへたらないので、雨の日用にもう1枚買い足す予定です。",
        "created_at": "2026-08-20T20:40:00+09:00",
    },
]
