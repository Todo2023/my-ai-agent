...
(function () {
  ...
  var NODES = [
    { id: 'me', cat: 'center', r: 28, label: '辰巳彩香',
      body: 'この地図の真ん中。頭の中にあるものを、丸にして並べています。いまは合同会社To doのぶんだけが埋まっていて、そのほかはまだ空のまま。丸はドラッグで動かせます。' },
    ...
    { id: 'q1', cat: 'blank', r: 12, label: '仕事のほかに時間を使っていること',
      ...
      waiting: '教えてもらえれば、ここに中身が入って、下に丸が増えます。' },
    { id: 'q2', cat: 'blank', r: 12, label: 'これからやってみたいこと',
      body: 'まだ聞いていません。会社としてでも、そうでなくても構いません。',
      waiting: '教えてもらえれば、ここに中身が入って、下に丸が増えます。' },
    ...
    { id: 'blank', cat: 'blank', r: 15, label: 'まだ白いところ',
      ...
      waiting: '請求書が入れば、ここも発信できる中身になります。' },
  ...
  function renderPanel(n) {
    ...
    if (n.post) {
      ...
      html += '<div class="post"><p class="post__note">この丸はまだ中身が無いので、投稿文は作っていません。'
        + esc(n.waiting || '中身が入れば、ここも発信できるようになります。') + '</p></div>';
    }
